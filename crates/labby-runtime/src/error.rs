...
impl From<labby_apis::mcpregistry::error::RegistryError> for ToolError {
    fn from(e: labby_apis::mcpregistry::error::RegistryError) -> Self {
        use labby_apis::mcpregistry::error::RegistryError;
        match e {
...
impl From<labby_apis::acp_registry::AcpRegistryError> for ToolError {
    fn from(e: labby_apis::acp_registry::AcpRegistryError) -> Self {
        use labby_apis::acp_registry::AcpRegistryError;
...
#[cfg(feature = "acp_registry")]
impl From<labby_apis::acp_registry::AcpInstallerError> for ToolError {
    fn from(e: labby_apis::acp_registry::AcpInstallerError) -> Self {
        Self::Sdk {
...
#[cfg(feature = "deploy")]
impl From<labby_apis::deploy::DeployError> for ToolError {
    fn from(e: labby_apis::deploy::DeployError) -> Self {
        Self::Sdk {
            sdk_kind: e.kind().to_string(),
