...
//!
//! Canonical public types live in `labby_apis::acp::types` under the `Acp*`
...
pub struct ProviderHealth {
    ...
    pub args: Vec<String>,
    pub message: String,
    pub models: Vec<labby_apis::acp::types::AcpModelOption>,
...
pub struct StartSessionResult {
    ...
    pub model_name: Option<String>,
    pub models: Vec<labby_apis::acp::types::AcpModelOption>,
    pub config_options: Vec<labby_apis::acp::types::AcpSessionConfigOptionView>,
}
