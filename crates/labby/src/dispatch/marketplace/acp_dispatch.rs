...
#[cfg(feature = "acp_registry")]
use labby_apis::acp_registry::client::AcpRegistryClient;
#[cfg(feature = "acp_registry")]
use labby_apis::acp_registry::installer::{AcpInstaller, InstallSpec};
#[cfg(feature = "acp_registry")]
use labby_apis::acp_registry::types::{Agent, BinaryAsset};
...
/// rejection, setuid strip) live in `labby_apis::acp_registry::installer`. This
...
mod tests {
    ...
    fn archive_url_validation_delegates_to_installer() {
        ...
        use labby_apis::acp_registry::AcpInstaller;
