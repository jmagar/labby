# Uptime Kuma MCP Reference

This skill uses the Lab MCP integration for `uptime-kuma`. The authoritative action catalog is live and should be discovered at call time.
