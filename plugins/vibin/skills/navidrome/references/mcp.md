# Navidrome MCP Reference

This skill uses the Lab MCP integration for `navidrome`. The authoritative action catalog is live and should be discovered at call time.
