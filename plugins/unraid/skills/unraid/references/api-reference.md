...
> **GraphQL reference** — the complete query/mutation catalog for the `gql` curl helper defined in [`SKILL.md`](../SKILL.md). Use these examples directly against `$UNRAID_URL/graphql`.
